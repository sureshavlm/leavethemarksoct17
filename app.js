...
var routes=require('./routes/route.js');//globals routes
var user=require('./routes/user.js'); //user routes
var story=require('./routes/story.js'); //sotry CRUD
